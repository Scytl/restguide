...
As mentioned in <<JSON Web Token>> section, _JWT_ is the approach used to secure RESTful Web Services endpoints.
Almost all work is done in backend-side and for this example we are going to focus on not going to take into consideration other security aspects like encryption.
